...
HarnessFlow follows SemVer. `v0.1.0` is a pre-release (see [`CHANGELOG.md`](CHANGELOG.md)).

| Version | Supported for security fixes |
|---|---|
| `0.1.x` (pre-release) | Best-effort; fixes shipped via patch releases on the `main` branch |
