...
- Release: `v1.0.0`
- Date: 2026-05-23
- Scope: full repository regression for stable release metadata, skills, agents, commands, OpenCode runtime asset layout, Cursor rule path rewrite, and release pack.
- Conclusion: PASS
...
- Install regression explicitly verifies OpenCode `.opencode/skills` + `.opencode/agents` + `.opencode/commands`, top-level `agents/`, and Cursor installed rule path rewriting.
