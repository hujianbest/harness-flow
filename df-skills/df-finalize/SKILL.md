...
- 长期资产同步必须按 promotion rules（见 `references/promotion-checklist.md` 与 `docs/df-workflow-shared-conventions.md` 的 Promotion Rules 节）执行
...
| `docs/df-workflow-shared-conventions.md` | 路径、canonical 字段、Promotion Rules |
