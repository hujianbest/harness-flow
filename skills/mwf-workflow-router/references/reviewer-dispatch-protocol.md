# mwf Reviewer Dispatch Protocol

> 配套 `mwf-workflow-router/SKILL.md`。规定 mwf 中 review 节点如何派发独立 reviewer subagent，以及 reviewer 返回结果的契约。

## 角色边界

mwf 的 review 节点（spec-review / component-design-review / ar-design-review / test-checker / code-review）必须由**独立 reviewer 角色或 subagent** 执行，理由：
...
- `expected_record_path`：默认见 `mwf-workflow-shared-conventions.md`，项目覆写优先
...
- 若问题本质属于 stage / route / profile 冲突，必须 `reroute_via_router=true` 且 `next_action_or_recommended_skill=mwf-workflow-router`
...
|---|---|---|---|---|
| `mwf-spec-review` | `mwf-component-design`（component-impact）/ `mwf-ar-design` | `mwf-specify` | `mwf-specify` | `mwf-workflow-router` |
| `mwf-component-design-review` | `mwf-ar-design` | `mwf-component-design` | `mwf-component-design` | `mwf-workflow-router` |
| `mwf-ar-design-review` | `mwf-tdd-implementation` | `mwf-ar-design` | `mwf-ar-design` | `mwf-workflow-router` |
| `mwf-test-checker` | `mwf-code-review` | `mwf-tdd-implementation` | `mwf-tdd-implementation` | `mwf-workflow-router` |
| `mwf-code-review` | `mwf-completion-gate` | `mwf-tdd-implementation` | `mwf-tdd-implementation` | `mwf-workflow-router` |
