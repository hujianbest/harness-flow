...
- implementation and quality: `hf-test-driven-dev` / `hf-browser-testing` / `hf-test-review` / `hf-code-review` / `hf-traceability-review` / `hf-regression-gate` / `hf-completion-gate` / `hf-finalize`
