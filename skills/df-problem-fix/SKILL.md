...
按 Artifact Layout（df-principles 03），新 DTS 用 `templates/df-work-item-readme-template.md` / `templates/df-progress-template.md` 创建 `features/DTS<id>-<slug>/README.md` 与 `progress.md`；已存在则核对 canonical 字段。缺 DTS ID / 所属组件 → 阻塞。
...
| `skills/templates/df-work-item-readme-template.md` | DTS work item README 模板 |
| `skills/templates/df-progress-template.md` | progress.md 模板 |
| `skills/docs/df-workflow-shared-conventions.md` | hotfix profile 路径与 canonical 字段 |
