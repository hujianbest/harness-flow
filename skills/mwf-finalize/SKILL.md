...
按 Promotion Rules（`docs/mwf-principles/03 artifact-layout.md` + `references/promotion-checklist.md`），按 Sync-On-Presence：
...
按 `templates/mwf-closeout-template.md` 写入 `features/<id>/closeout.md`，包含 Closeout Summary、Evidence Matrix、Long-Term Assets Sync、State Sync、Handoff。pack 缺关键字段 → 回步骤 2-4 补齐。
