...
- 测试设计被拆成独立 `test-design.md` 文件（违反 df-principles）
...
| `skills/templates/df-ar-design-template.md` | 团队 AR 设计模板（待团队补齐） |
| `skills/docs/df-workflow-shared-conventions.md` | 工件路径、canonical 字段、handoff |
| `docs/df-principles/03 artifact-layout.md` | AR 设计必含项 |
| `docs/df-principles/04 workflow-architecture.md` | Test Design Before Implementation |
