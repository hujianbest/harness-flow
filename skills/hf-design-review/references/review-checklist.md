...
| `A11` | upfront-gof-pattern | 设计文档列出 GoF 代码模式（Strategy / Factory / Adapter / Observer / Decorator / Builder / Singleton）作为前置决策，理由是 "为了扩展 / 通用 / 未来可能多一种实现" | 从设计文档移除；GoF 模式应 emergent 浮现，由 `hf-test-driven-dev` REFACTOR 步按 Fowler vocabulary 处理；立场见 `skills/principles/emergent-vs-upfront-patterns.md` |
